...
public class PartnerService
{
    ...
    public PartnerService(InvestProDbContext db)
    {
        _db = db;
        _repo = new EfRepository<Partner>(db);
    }
    ...
    /// the form supplies.
    /// </summary>
    public Task<Partner?> GetByUserIdAsync(Guid userId, CancellationToken ct = default)
        => _db.Partners
